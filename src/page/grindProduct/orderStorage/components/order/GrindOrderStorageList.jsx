...
import { Button, Card, Drawer, Modal, Row, message } from "antd";
      ...
      {isLoading ? (
        ...
        <Row style={{ width: "100%" }} gutter={[16, 16]}>
          ...
          <>
            ...
            <Modal title="Chek" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
              <p>Chek chiqarishni hohlaysizmi</p>
            </Modal>
          </>
        </Row>
      )}
