...
import { useAddAdminDividendAncloseMutation } from "../../../../features/admin/dividendAnclose/adminDividendAncloseApiSlice";

function AdminAddDividendAncloseModal() {
  /* Form */
...
export default AdminAddDividendAncloseModal;
