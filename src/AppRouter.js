...
import {
  ...
  AdminDividend,
  AdminDividendAnclose,
  AdminDividendCategory,
  AdminHome,
  AdminLayout,
  AdminPolka,
  AdminProduct, AdminReportGrind, AdminResidue,
  AdminUser,
  AdminWorker,
  AgentHome,
  AgentLayout,
  ...
  UploaderReportReception, UploaderResidue,
...
import {
  ...
  PRODUCT_STORAGE_ORDER_GRIND_ROUTE,
  ...
  SUPPLIER_DEBT_ROUTE,
  SUPPLIER_HOME_ROUTE,
  SUPPLIER_MY_ACCOUNT_ROUTE,
  SUPPLIER_MY_INDICATOR,
  SUPPLIER_MY_TERRITORY_ROUTE,
  ...
  UPLOADER_REPORT_ROUTE,
  UPLOADER_RETURN_PRODUCT_ROUTE,
  UPLOADER_SALES_ORDER_PROCESS_ROUTE,
  UPLOADER_SPARE_ROUTE, SUPPLIER_DEADLINE_ROUTE, UPLOADER_RESIDUE_ROUTE, PRODUCT_STORAGE_RESIDUE, GRIND_RESIDUE,
} from "./util/path";
import SupplierDeadlineChecker from "./components/supplier/deadlineChecker/SupplierDeadlineChecker"
    ...
    <Routes>
      ...
      <Route element={<AuthRequired allowRoles={[ROLE_LIST.admin]} />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path={admin_routes.devidentAnclose} element={<AdminDividendAnclose />} />
          <Route
            path={admin_routes.devidentCategory}
            element={<AdminDividendCategory />}
          />
          <Route path={admin_routes.residue} element={<AdminResidue />} />
          <Route path={admin_routes.reportGrind} element={<AdminReportGrind />} />
          
          <Route path={admin_routes.reportSupplier} element={<ReportSupplier />} />
      ...
      <Route element={<AuthRequired allowRoles={[ROLE_LIST.sales]} />}>
        <Route path={SALES_HOME_ROUTE} element={<SalesLayout />}>
          ...
          />
          <Route
            path={SALES_CUSTOMER_DATA_ROUTE}
            element={<SalesCustomerData />}
          />
          <Route
      ...
      {/* UPLOADER */}
      <Route element={<AuthRequired allowRoles={[ROLE_LIST.uploader]} />}>
        <Route element={<UploaderNotifChecker />}>
          <Route path={UPLOADER_HOME_ROUTE} element={<UploaderLayout />}>
            <Route path={UPLOADER_HOME_ROUTE} element={<UploaderHome />} />
            <Route
      ...
      <Route element={<AuthRequired allowRoles={[ROLE_LIST.supplier]} />}>
        <Route element={<SupplierNotifChecker />}>
          <Route element={<SupplierDeadlineChecker />}>
