// const MAIN_API = "https://mysystem.uz/brothers/api/";
const MAIN_API = "https://shehroz-company.uz/brothers/api";

// const MAIN_API = "https://shehroz-company.uz/brothers-demo/api";
...
const ADMIN_API = {
    ...
    // REPORT SUPPLIER 
    REPORT_SUPPLIER_GET: ({start, end}) => `/admin/get-dostavka-stat.php?sana1=${start}&sana2=${end}`,
    ...
    GET_BENEFIT: ({start, end}) => `/admin/get-foyda.php?sana1=${start}&sana2=${end}`,
...
const PRODUCT_STORAGE = {
    ...
    // Dashboard 
    DASHBOARD_GET: (date) => 
        `/saqlash/get-index-data.php?sana1=${date.start}&sana2=${date.end}`,
    /* REPORT */
    REPORT_GET: (date) =>
